...
public class ClientSide implements ActionListener {
    ...
    public ClientSide() {
        ...
        // Title
        JLabel title = new JLabel("Client Side");
...
/*
        ...
        text_area.setFont(new Font("Ubuntu", Font.PLAIN, 18));
        text_area.setBackground(new Color(52, 53, 54));
        text_area.setForeground(new Color(226, 205, 150));
        text_area.setBounds(0, 50, 400, 494);
        ...
        *//*
        ...
        receive_text_area.setBackground(new Color(61, 106, 113));
        receive_text_area.setForeground(new Color(226, 205, 150));
        receive_text_area.setBounds(0, 50, 200, 494);
        ...
        send_text_area.setBackground(new Color(236, 2, 57));
        send_text_area.setForeground(new Color(226, 205, 150));
        send_text_area.setBounds(200, 50, 200, 494);
        ...
        // Main Frame
        frame.getContentPane().setBackground(new Color(48, 49, 52));
        frame.setLayout(null);
        frame.setSize(400, 650);
        frame.setLocation(800, 80);
    ...
    public static void main(String args[]) throws IOException {
        ...
        new ClientSide().frame.setVisible(true);
        ...
        try {
            ...
            while (true) {
                ...
                if (message_receive.equals("this_is_a_file_##00")) {
                    ...
                    String client_path_str = System.getProperty("user.dir") + "/files/client_receive";
