...
public class PrayTime {
    ...
    private int dhuhrMinutes; // Minutes after midday for Dhuhr
    ...
    // Time Names
    protected ArrayList<String> timeNames;
    protected String InvalidTime; // The string used for invalid times
    // --------------------- Technical Settings --------------------
    private int numIterations; // number of iterations needed to compute times
    // ------------------- Calc Method Parameters --------------------
    protected HashMap<Integer, double[]> methodParams;
    ...
    public static double getTimeZoneHours() {
        ...
        return timeZoneDiff/(1000*60*60);
    }
    /**
     * @param args
     */
    public static void main(String[] args) {
        double latitude = 23.7900194;
        double longitude = 90.3739717;
        double timezone = getTimeZoneHours();
        // Test Prayer times here
        PrayTime prayers = new PrayTime();

        prayers.setTimeFormat(prayers.Time12);
        prayers.setCalcMethod(prayers.Karachi); // Jafari
